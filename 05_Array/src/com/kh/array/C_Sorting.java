...
public class C_Sorting {
	...
	public void method3() {
		...
		System.out.println(score[0]); // 최소값
		System.out.println(score[score.length-1]); // 최대값
	}
	...
	/*
	 * 삽입정렬(insertion sort)
	 * - 동작 원리는 직관적, 선택 정렬에 비해서는 난이도가 높음
	 ...
	 * - 구현이 쉽다는 장점이 있지만, 다른 정렬에 비해 속도가 느리며, 역순으로 정렬할 때 가장 느린 속도를 가짐
	 * 
	 * 7, 5, 9, 0, 3, 1, 6, 2, 4, 8
	 * 5, 7, 0, 3, 1, 6, 2, 4, 8, 9
	 * 5, 0, 3, 1, 6, 2, 4, 7, 8, 9
