...
public class A_Array {
	...
	public void method1() {
		 ...
		 * 참조 자료형 : 실제 데이터 값은 힙 메모리에 저장하고, 스택 메모리의 변수 공간에는 실제 변수값이 저징된 힙 메모리의 주소값을 저장
		 */
//		System.out.println(score); // [I@3d012ddd
	...
	// 2) 선언과 동시에 초기화
	public void method2() {
		int[] score = /*new int[]*/ {100, 90, 80, 70, 60}; // 생략 가능
		
//		int[] score2;
//		score2 = {100, 90, 80, 70, 60}; // 선언 후 초기화 에러
		
		// 반복문 사용해서 출력
		// 문자열.length() - 메소드, 배열.length - 변수
	...
	/*
	 * 3명의 키를 입력받아서 배열에 저장하고 3명의 키의 평균값을 구하시오.
	 * 키 입력 > 180
	 * 키 입력 > 177.3
	 * 키 입력 > 168.2
	 * 175.2
	...
	public void method4() {
		...
		System.out.printf("%.1f", sum/height.length); // 평균값 소수점 첫째자리까지
	}
