...
//		a.method1();
	...
	public void method1() {
		...
		stream.distinct().forEach(name -> System.out.print(name + " ")); // forEach는 최종처리
	...
	public void method2() {
		...
		names.stream().distinct().filter(name -> name.startsWith("김")).forEach(name -> System.out.print(name + " ")); // 중간 처리는 순서 상관 없음
