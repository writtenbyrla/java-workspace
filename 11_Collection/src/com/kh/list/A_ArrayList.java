...
//		a.method3();
	...
	public void method1() {
		List list = new ArrayList(); // 크기 지정 안함
		list.add("김민소");
		list.add("김민수");
		list.add("김준우");
		list.add("김준영");
	...
	public void method2() {
		 ...
		 */
		ArrayList<Person> list = new ArrayList(); // Person 객체만 담을 수 있음
...
//		System.out.println(list);
		...
		List sub = list.subList(0, 2); // 0 ~ 2 사이(0, 1)
...
//		}
		...
		// 나이 또는 이름 순서대로 출력 - Person클래스에서 CompareTo 메서드 
	...
	public void method3() {
		...
		// 13. 내림차순 정렬
		Collections.reverse(list); // 오름차순 정렬 생략시 기본 정렬에서 역순으로 출력됨
		System.out.println(list);
	}
