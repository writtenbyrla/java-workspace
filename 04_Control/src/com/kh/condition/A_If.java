...
//		if (score >= 60) // 중괄호 생략 가능하나 가능하면 사용
//			System.out.println("합격!");
//			System.out.println("축하드려요!");
		
		if(score >= 60) System.out.println("합격!"); // 실행 코드가 한줄일 경우는 이렇게도 사용 가능함
	...
	public void method3() {
		...
		System.out.println("김지은" == name); // false // 참조형 변수(string)는 주소값으로 저장하기 때문에 실제 값이 아님
		System.out.println("김지은".equals(name)); // true, String 클래스의 equals() 메소드
		System.out.println("김지은".charAt(0)); // String 클래스의 charAt(0) 메소드
